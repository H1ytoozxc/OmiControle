...
const T = {
  en: {
    ...
    profile: {
      ...
      avatarSection: "Avatar & identity",
      changeAvatar: "Change avatar",
      removeAvatar: "Remove",
      avatarHint: "JPG, PNG, GIF, WebP — max 4 MB",
      displayName: "Display name",
      displayNamePlaceholder: "Jane Smith",
      emailLabel: "Email",
      bio: "Bio",
      ...
      deleteAccountNote: "Permanently delete your account and all data. This cannot be undone.",
    },
  },
  ...
  ru: {
    ...
    profile: {
      ...
      avatarSection: "Аватар и личные данные",
      changeAvatar: "Изменить аватар",
      removeAvatar: "Удалить",
      avatarHint: "JPG, PNG, GIF, WebP — макс. 4 МБ",
      displayName: "Отображаемое имя",
      displayNamePlaceholder: "Иван Иванов",
      emailLabel: "Email",
      bio: "О себе",
      bioPlaceholder: "Несколько слов о вас…",
      ...
      sessionSection: "Информация об аккаунте",
      active: "активен",
      ...
      deleteAccountNote: "Безвозвратно удалит аккаунт и все данные. Отменить нельзя.",
    },
  },
} as const;

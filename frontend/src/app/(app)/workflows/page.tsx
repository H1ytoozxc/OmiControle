    ...
    <div className="space-y-5">
      <header className="flex items-end justify-between gap-6 fade-up">
        <div>
          ...
          <h1 className="text-[36px] font-semibold leading-tight text-bone tracking-tight">Workflows</h1>
          <p className="text-[12.5px] text-bone-muted mt-1">Automate device operations with event-driven workflows.</p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline">Import blueprint</Button>
          <Button variant="ember" asChild>
            <Link href="/workflows/builder/new">
              <Plus className="w-3.5 h-3.5" strokeWidth={1.8} />New workflow
            </Link>
          </Button>
        </div>
      </header>
      ...
      <Plate className="fade-up" style={{ ["--d" as never]: "80ms" }}>
        <PlateHeader>
          <PlateTitle label="Definitions" subtle="0 defined" />
        </PlateHeader>
        <PlateBody>
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-[14px] text-bone mb-1">No workflows yet</p>
            <p className="text-[12.5px] text-bone-muted max-w-[320px] leading-relaxed mb-5">
              Create a workflow to automate secret rotation, anomaly response, provisioning, and more.
            </p>
            <Button variant="ember" size="md" asChild>
              <Link href="/workflows/builder/new">
                <Plus className="w-3.5 h-3.5" strokeWidth={1.8} />Create first workflow
              </Link>
            </Button>
          </div>
        </PlateBody>
